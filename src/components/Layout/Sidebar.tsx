...
import {BarChart3, LayoutDashboard, PiggyBank, Receipt, Settings, Target, Wallet} from "lucide-react";
        ...
        <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col border-r border-border bg-sidebar">
            <div className="flex flex-col flex-1 min-h-0">
                <div className="flex items-center h-16 px-6 border-b border-border">
                    ...
                    <span className="ml-3 text-xl font-bold text-foreground">Finance Flow</span>
                </div>
